...
Everything comes from each paper's metadata/paper.yaml, so updating an author
list or a title in one place updates every format.
...
# Generated by publishing/cite_this.py from papers/*/metadata/paper.yaml —
# edit those.
cff-version: 1.2.0
