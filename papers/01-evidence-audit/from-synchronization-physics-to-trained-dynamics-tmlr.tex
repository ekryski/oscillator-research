...
among the systems surveyed here, the damped second-order recurrences of
the coRNN \citep{rusch2021} and LinOSS \citep{rusch2025} lines share
that planar state, though without the amplitude-restoring terms that
make a rhythm self-sustaining, so they oscillate under drive rather than
on their own.
