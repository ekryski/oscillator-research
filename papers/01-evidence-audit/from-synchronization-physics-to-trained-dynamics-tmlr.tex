...
current landscape of ONNs. We organize thirteen published systems on two
...
on the D-dimensional generalization of \citet{chandra2019} in the lower
...
\item
  ...
  generalization as a layer inside a conventional network and reports
  ...
  on a torus under generalized Winfree dynamics, writing the input into
...
\ensuremath{\Omega} and J optimized against the task objective. Figure 8
...
\citep{akorn}. Appendix G itemizes them. Where a control has been run it
...
--- & parallel scan, implicit discretization \\
