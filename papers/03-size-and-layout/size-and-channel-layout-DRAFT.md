...
The tiers of the study, with their run counts. Every run is at 0 dB and input gain 1 (32 on the carrier pathway), is fitted on 2,048 training clips of speakers 1 to 48, is read at widths 192, 1,024 and 4,096 under the fixed and the seeded projection, and is scored on the 6,000 test clips of speakers 49 to 60. The 150 runs at 16 × 16 with four channels that the previous study recorded are taken from its record.
