...
| folder | contents |
|---|---|
| `results/` | the complete record, 6,353 runs in the paper's eight experiments (its README lists them), one file per experiment and task, with `summary.json` and `summary.md`; its [README](results/README.md) says what each file holds |
